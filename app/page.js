...
export default function Home() {
  ...
  const flickerDelays = [
    0, 0.3, 0.2, 0.6, 0.3, 0.5, 0.1, 0.2, 0.5, 0.3, 0.7, 0.4, 0.2, 0.8, 0.6,
    0.7, 0.2, 0.0, 0.9,
  ];
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center">
      ...
      <div className="absolute flex w-screen h-screen bg-center bg-cover bg-no-repeat bg-[url('/bg/mobnew.png')] sm:bg-[url('/bg/bgdark.png')]"></div>
      <div className="stars"></div>
      <div className=" z-10 flex flex-col transform scale-75 mb-20 mt-2 sm: sm:-mt-14  items-center justify-center relative">
        <div
          id="evolution_in_progress"
          className=" text-center mb-0.25 mt-2  sm:mb-1  text-white tracking-[0.1rem] sm:tracking-[0.3rem]   text-md sm:text-2xl"
        >
        ...
        <div
          id="excel_2024 "
          className="transform scale-90   expand mb-32 mt-1.5 sm:mt-2 "
        >
          <Image
            width={170}
            height={200}
            src="/bg/excel2023.svg"
            alt="Excel 2024"
            className="bigger sm:w-[390px] sm:h-[180px]"
          />
        </div>
        {/* video button */}
        <div className=" transform scale-50 ml-2 sm:h-30 sm:w-30 sm:top-62   cursor-pointer video_btn absolute top-60 right-0.25 left-0.25 -mt-24 sm:mt-12 sm:-mb-2 flex items-center justify-center  transition-shadow duration-300 ">
          <div
            className={`bg-glassmorphism w-24 h-24 sm:h-28 sm:w-28 rounded-lg pop-up play ml-4 mb-12 mr-5 sm:ml-4 sm:mt-6 sm:mb-24 relative bg-gradient-radial from-[rgb(133,102,255)] to-[#590662] flex items-center justify-center shadow-[0px_0.94rem_1.56rem_#8e9b9e66] transition-all duration-500 ${
      ...
      /> */}
        ...
        <div id="legend_logos" className="flex transform scale-90 sm:scale-100">
          <a
            href="https://2018.excelmec.org/"
            target="_blank"
