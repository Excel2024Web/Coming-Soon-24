...
<<<<<<< HEAD
          ...
          <a
            ...
            className="w-[48px] h-[48px] rounded-full flex items-center justify-center bg-gray-600 hover:bg-gray-400 transition-colors"
          >
            <FontAwesomeIcon icon={faTwitter} className="h-5 w-5 text-white shadow-[8px_8px_8px_rgba(0,0,0,0.5)] hover:shadow-[6px_6px_12px_rgba(0,0,0,0.5)] transition-shadow" />
          </a>
          <a
